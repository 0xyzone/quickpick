            ...
            <div>
                <p class="text-sm text-gray-700 leading-5 dark:text-gray-200">
                    ...
                    @if ($paginator->firstItem())
                        <span class="font-medium text-primary-500">{{ $paginator->firstItem() }}</span>
                        {!! __('to') !!}
                        <span class="font-medium text-primary-500">{{ $paginator->lastItem() }}</span>
                    @else
                    <span class="text-primary-500">{{ $paginator->count() }}</span>
                    @endif
                    {!! __('of') !!}
